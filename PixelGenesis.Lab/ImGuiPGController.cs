...
void main()
{
    outputColor = color * texture(in_fontTexture, texCoord);
       ...
       // _shaderProjectionMatrixLocation = GL.GetUniformLocation(_shader, "projection_matrix");
        ...
        //    GL.VertexAttribPointer(i, element.Count, GetPointerType(element.Type), element.Normalized, _layout.Stride, offset);            
...
//    private static VertexAttribPointerType GetPointerType(ShaderDataType type)
//    {
//        return type switch
//        {
...
//}
    ...
    private unsafe void RenderImDrawData(ImDrawDataPtr draw_data)
    {
        ...
        //_projectionuniformBlockBuffer.Bind();
        _projectionuniformBlockBuffer.SetData(mvp, 0);
        _shaderProgram.SetUniformBlock(0, _projectionuniformBlockBuffer);
        //GL.BindBufferBase(BufferRangeTarget.UniformBuffer, 0, _projectionuniformBlockBuffer.Id);
        ...
        for (int n = 0; n < draw_data.CmdListsCount; n++)
        {
            ...
            for (int cmd_i = 0; cmd_i < cmd_list.CmdBuffer.Size; cmd_i++)
            {
                ...
                else
                {
                    ...
                    {
                        _deviceApi.DrawTriangles(_vertexBuffer, _layout, _indexArrayBuffer, _shaderProgram, (int)pcmd.ElemCount, (int)pcmd.IdxOffset, (int)pcmd.VtxOffset);
                        //GL.DrawElementsBaseVertex(PrimitiveType.Triangles, (int)pcmd.ElemCount, DrawElementsType.UnsignedShort, (IntPtr)(pcmd.IdxOffset * sizeof(ushort)), unchecked((int)pcmd.VtxOffset));
                    }
                    else
                    {
                        _deviceApi.DrawTriangles(_vertexBuffer, _layout, _indexArrayBuffer, _shaderProgram, (int)pcmd.ElemCount, (int)pcmd.IdxOffset);
