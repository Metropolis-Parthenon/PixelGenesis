...
public interface IWindowInputs
{
    bool IsKeyboardKeyDown(PGInputKey key);
    bool IsMouseButtomDown(PGMouseButton button);
    Vector2 MousePosition { get; }
    Vector2 ScrollPosition { get; }
}

public enum PGMouseButton
{
    //
    // Summary:
    //     The first button.
